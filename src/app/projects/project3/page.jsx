...
export default function Project3() {
  return (
    <div className='container mx-auto px-4 py-20 md:px-6'>
      ...
      >
        <h1 className='mb-6 text-4xl font-bold text-gray-900'>Project 3</h1>
        <p className='mb-8 text-lg text-gray-600'>
          A data visualization dashboard that presents complex information in an
          intuitive interface. Features customizable charts and exportable
          reports.
        </p>
        ...
        <div className='mb-10'>
          ...
          <ul className='list-disc space-y-2 pl-5 text-gray-600'>
            <li>Interactive data visualization with D3.js</li>
            <li>Real-time data updates from Firebase</li>
            <li>Customizable dashboard layouts</li>
            <li>Export data to CSV or PDF formats</li>
