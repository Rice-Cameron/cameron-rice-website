    ...
    <div className='container mx-auto px-4 py-20 md:px-6'>
      ...
      >
        ...
        <p className='mb-8 text-lg text-gray-600'>
          A very simple Kotlin mobile application that fetches data from the API
          Ninjas Planets API and displays it. This project was built using
          Android Studio.
        </p>
        ...
        <div className='mb-10 grid grid-cols-1 gap-8 md:grid-cols-2'>
          <div>
            ...
            <p className='text-gray-600'>
              This app fetches and displays planet data using an external API.
      ...
      {isOpen && (
        ...
        >
          <div className='relative w-full max-w-md rounded-lg bg-white p-4 shadow-lg'>
            ...
            <video
              controls
              className='h-[75vh] max-h-[600px] w-full rounded-lg object-contain'
              src='/planets.webm'
            />
          </div>
        </motion.div>
